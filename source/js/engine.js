  ...
  if (act === "openingBrainstorm") commitAction({ actionId: act, mutate: d => { d.viewDescriptor = "opening_brainstorm"; d.currentPhase = "story"; } });
    ...
    commitAction({
      actionId: act, mutate: d => {
        ...
        if (id === "assessment") { d.assessmentRemaining -= 20; d.assessmentWorkedTonight = true; } // FIX: R5 assessment work now correctly makes "task quicker than expected" reachable in Life Happens 3
